 ...
 * Displays a preview of the selected image with options to replace or remove.
 * @param props - Component props
 * @param props.onUpload - Callback fired when an image is uploaded
...
export function ImageUpload({ onUpload, className }: ImageUploadProps) {
  ...
  return (
    <div
      className={cn(
        "bg-card border-border w-full max-w-md space-y-6 rounded-xl border p-6 shadow-sm",
        className
      )}
    >
