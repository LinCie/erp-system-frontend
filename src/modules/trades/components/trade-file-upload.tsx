...
import { type TradeFile } from "../schemas";
...
/**
 * Preview item for displaying files (both File objects and existing TradeFile)
 */
interface PreviewItem {
  ...
  isExisting: boolean;
  file?: File;
  existingFile?: TradeFile;
}

interface TradeFileUploadProps {
  /** Field name for form submission */
  name: string;
  /** Existing files from the trade (for update mode) */
  existingFiles?: TradeFile[];
  /** Callback when files change */
  onChange?: (files: File[]) => void;
  /** Callback when existing files are removed */
  onExistingFilesChange?: (files: TradeFile[]) => void;
...
/**
 * File upload component for trades with support for:
 * - Single or multiple file selection
 * - Drag and drop
 * - Existing file display (for update mode)
 * - Remove functionality
 */
export function TradeFileUpload({
  name,
  existingFiles = [],
  onChange,
